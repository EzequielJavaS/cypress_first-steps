...
describe('Test NuevaCuenta Component', () => {
    it('Validation and alerts', ()=>{
        ...
        // cy.get('[data-cy=nombre-input]').type('Antonio'); //Estoy simulando la escritura de Ezequiel en el input.
        // cy.get('[data-cy=email-input]').type('antonio@gmail.com'); 
        // cy.get('[data-cy=password-input]').type('123456789'); //Simulo una introducción de password errónea para que salte alerta
        // cy.get('[data-cy=repPass-input]').type('123456789');
